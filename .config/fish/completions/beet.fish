...
set CMDS bpd completion config edit fetchart fields fish ? help imp im import ls list mod modify mv move rm remove splupdate stats upd up update version write
