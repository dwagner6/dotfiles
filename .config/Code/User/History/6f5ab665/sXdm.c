...
void configure_pin27( void )
{
    ...
    io_bank0 -> proc0_inte2 |= (IO_BANK0_PROC0_INTE1_GPIO13_EDGE_HIGH_MASK
                                | IO_BANK0_PROC0_INTE1_GPIO13_EDGE_LOW_MASK);
}

static void callback()
{
    if( io_bank0 -> proc0_ints2 & IO_BANK0_PROC0_INTS1_GPIO13_EDGE_HIGH_MASK)
        pin_state = true;            
    if( io_bank0 -> proc0_ints2 & IO_BANK0_PROC0_INTS1_GPIO13_EDGE_LOW_MASK)
        pin_state = false;
}
