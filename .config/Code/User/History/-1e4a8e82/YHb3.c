...
void configure_gpio11_irq( void )
{
    ...
    io_bank0 -> proc0_inte1 |=       (IO_BANK0_PROC0_INTE1_GPIO11_EDGE_HIGH_MASK | IO_BANK0_PROC0_INTE1_GPIO11_EDGE_LOW_MASK);
}

static void callback()
{
    if(io_bank0 -> proc0_ints1 & IO_BANK0_PROC0_INTS1_GPIO11_EDGE_HIGH_MASK)
        pin_state = true;
    else
        pin_state = false;
}
