...
*
* DESCRIPTION :     Implementation of power supply application.  Includes
...
void power_supply_fsm()
{
    ...
    static enum {RESET, OFF, ON, SHORT} state = RESET;
...
static void short_circuit()
{
    ...
    lcd_print_string("SHORT: EN TO CLR");
}
