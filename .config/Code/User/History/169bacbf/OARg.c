...
void configure_gpio12( void )
{
    ...
    io_bank0 -> proc0_inte3 |= (IO_BANK0_PROC0_INTE1_GPIO12_EDGE_HIGH_MASK
                                | IO_BANK0_PROC0_INTE1_GPIO12_EDGE_LOW_MASK);
}

static void callback()
{
    if( io_bank0 -> proc0_ints1 & IO_BANK0_PROC0_INTS1_GPIO12_EDGE_HIGH_MASK)
        pin_state = true;            
    if( io_bank0 -> proc0_ints1 & IO_BANK0_PROC0_INTS1_GPIO12_EDGE_LOW_MASK)
        pin_state = false;
}
